    ...
    implements Runnable, FlowConstructAware, MuleContextAware, Startable, Stoppable, MessageSource
{
    ...
    public FilteredStreamMessageSource(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((TwitterConnector) object).filteredStream(transformedCount, transformedUserIds, transformedKeywords, sourceCallback);
                    return null;
                }
