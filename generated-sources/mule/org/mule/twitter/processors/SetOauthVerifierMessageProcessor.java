    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    protected RequestToken _requestTokenType;
    protected Object oauthVerifier;
    protected String _oauthVerifierType;

    public SetOauthVerifierMessageProcessor(String operationName) {
        super(operationName);
    }
     ...
     */
    public void setRequestToken(Object value) {
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((TwitterConnector) object).setOauthVerifier(_transformedRequestToken, _transformedOauthVerifier);
                }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        return new DefaultResult<MetaData>(new DefaultMetaData(getPojoOrSimpleModel(AccessToken.class)));
    }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at TwitterConnector at setOauthVerifier retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
