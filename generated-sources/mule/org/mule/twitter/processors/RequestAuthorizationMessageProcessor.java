    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public RequestAuthorizationMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedCallbackUrl = ((String) evaluateAndTransform(getMuleContext(), event, RequestAuthorizationMessageProcessor.class.getDeclaredField("_callbackUrlType").getGenericType(), null, callbackUrl));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((TwitterConnector) object).requestAuthorization(_transformedCallbackUrl);
                }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        return new DefaultResult<MetaData>(new DefaultMetaData(getPojoOrSimpleModel(RequestToken.class)));
    }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at TwitterConnector at requestAuthorization retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
