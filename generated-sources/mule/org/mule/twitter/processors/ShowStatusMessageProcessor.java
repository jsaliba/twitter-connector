    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public ShowStatusMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((TwitterConnector) object).showStatus(_transformedId);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at TwitterConnector at showStatus retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
