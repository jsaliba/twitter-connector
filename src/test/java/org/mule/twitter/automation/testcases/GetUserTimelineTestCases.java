...
public class GetUserTimelineTestCases extends TwitterTestCase {
	...
	public void testGetUserTimelineDefaultValues() {
		...
		try {
			...
			flow = lookupFlowConstruct("get-user-timeline-default-values");
	...
	public void testGetUserTimelineParametrized() {
		...
		try {
			...
			flow = lookupFlowConstruct("get-user-timeline-parameterized");
