...
public class GetRetweetsOfMeTestCases extends TwitterTestCase {
	...
	public void testGetRetweetsOfMeDefaultValues() {
		...
		TestStatus aRetweet = (TestStatus) testObjects.get("firstRetweetedStatus");
		
		try {
			
			flow = lookupFlowConstruct("get-retweets-of-me-default-values");
	...
	public void testGetRetweetsOfMeParametrized() {
		...
		try {
			...
			flow = lookupFlowConstruct("get-retweets-of-me-parametrized");
