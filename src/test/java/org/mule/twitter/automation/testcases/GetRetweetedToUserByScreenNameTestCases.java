...
public class GetRetweetedToUserByScreenNameTestCases extends TwitterTestCase {
	...
	@Test
	public void testGetRetweetedToUserByScreenName() {
		...
		try {
			...
			flow = lookupFlowConstruct("get-retweeted-to-user-by-screen-name-default-values");
			response = flow.process(getTestEvent(screenName));
