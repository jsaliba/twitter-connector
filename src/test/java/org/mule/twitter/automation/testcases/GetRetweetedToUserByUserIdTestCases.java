...
public class GetRetweetedToUserByUserIdTestCases extends TwitterTestParent {
	...
	@Test
	public void testGetRetweetsToUserByScreenName() {
		
    	followerSandbox =  (TwitterSandbox) context.getBean("auxAuxSandbox");
		...
		try {
			...
			flow = lookupFlowConstruct("get-retweeted-to-user-by-user-id-default-values");
			response = flow.process(getTestEvent(userId));
