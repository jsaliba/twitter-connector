...
public abstract class BaseTwitterConnector implements MuleContextAware {
    ...
    //TODO as part of the OAuth support, both subclasses have too much in common, see if a TwitterUtils could apply
    protected abstract Twitter getTwitter();
    //TODO as part of the OAuth support, both subclasses have too much in common, see if a TwitterUtils could apply
    protected abstract TwitterStream getTwitterStream();
    ...
    public ResponseList<Status> getHomeTimeline(@Placement(group = "Pagination") @Default(value = "1") @Optional int page,
        ...
        return getTwitter().getHomeTimeline(getPaging(page, count, sinceId));
    }
    ...
    public ResponseList<Status> getUserTimelineByScreenName(String screenName,
                                                            ...
                                                            @Placement(group = "Pagination") @Default(value = "-1") @Optional long sinceId)
            throws TwitterException {
        return getTwitter().getUserTimeline(screenName, getPaging(page, count, sinceId));
    }
    ...
    public ResponseList<Status> getUserTimelineByUserId(long userId,
                                                        ...
                                                        @Placement(group = "Pagination") @Default(value = "-1") @Optional long sinceId)
            throws TwitterException {
        return getTwitter().getUserTimeline(userId, getPaging(page, count, sinceId));
    }
    ...
    public ResponseList<Status> getUserTimeline(@Placement(group = "Pagination") @Default(value = "1") @Optional int page,
                                                ...
                                                @Placement(group = "Pagination") @Default(value = "-1") @Optional long sinceId)
            throws TwitterException {
        return getTwitter().getUserTimeline(getPaging(page, count, sinceId));
    }
    ...
    public ResponseList<Status> getMentionsTimeline(@Placement(group = "Pagination") @Default(value = "1") @Optional int page,
                                                    ...
                                                    @Placement(group = "Pagination") @Default(value = "-1") @Optional long sinceId)
            throws TwitterException {
        return getTwitter().getMentionsTimeline(getPaging(page, count, sinceId));
    }
    ...
    public ResponseList<Status> getRetweetsOfMe(@Placement(group = "Pagination") @Default(value = "1") @Optional int page,
                                                ...
                                                @Placement(group = "Pagination") @Default(value = "-1") @Optional long sinceId)
            throws TwitterException {
        return getTwitter().getRetweetsOfMe(getPaging(page, count, sinceId));
    }
    ...
    public User showUser() throws TwitterException {
        return getTwitter().showUser(getTwitter().getId());
    }
    ...
    public PagableResponseList<User> getFollowers(@Default(value = "-1") @Optional long cursor)
            throws TwitterException{
        return getTwitter().getFollowersList(getTwitter().getId(), cursor);
    }
    ...
    public Status updateStatus(String status,
        ...
        Status response = getTwitter().updateStatus(update);
    ...
    public Status destroyStatus(long statusId) throws TwitterException {
        return getTwitter().destroyStatus(statusId);
    }
    ...
    public Status retweetStatus(long statusId) throws TwitterException {
        return getTwitter().retweetStatus(statusId);
    }
    ...
    public ResponseList<Status> getRetweets(long statusId) throws TwitterException {
        return getTwitter().getRetweets(statusId);
    }
    ...
    public AccessToken setOauthVerifier(@Optional RequestToken requestToken, String oauthVerifier) throws TwitterException {
        ...
        if (requestToken != null) {
            accessToken = getTwitter().getOAuthAccessToken(requestToken, oauthVerifier);
        }
        else {
            accessToken = getTwitter().getOAuthAccessToken(oauthVerifier);
        }
    ...
    public RequestToken requestAuthorization(@Optional String callbackUrl) throws TwitterException {
        RequestToken token = getTwitter().getOAuthRequestToken(callbackUrl);
        return token;
    }
    ...
    public ResponseList<Place> reverseGeoCode(@Placement(group = "Coordinates") @Optional Double latitude,
            ...
            throws TwitterException {
        return getTwitter().reverseGeoCode(createQuery(latitude, longitude, null));
    }
    ...
    public ResponseList<Place> searchPlaces(@Placement(group = "Coordinates") @Optional Double latitude,
        ...
        return getTwitter().searchPlaces(createQuery(latitude, longitude, ip));
    }
    ...
    public Place getGeoDetails(String id) throws TwitterException {
        return getTwitter().getGeoDetails(id);
    }
    ...
    public Place createPlace(String placeName,
        ...
        return getTwitter().createPlace(placeName, containedWithin, token, new GeoLocation(latitude, longitude),
                streetAddress);
    }
    ...
    public SimilarPlaces getSimilarPlaces(@Placement(group = "Coordinates") Double latitude,
                                          ...
                                          @Optional String streetAddress) throws TwitterException {
        return getTwitter().getSimilarPlaces(new GeoLocation(latitude, longitude),
    ...
    public ResponseList<Location> getAvailableTrends()
        ...
        return getTwitter().getAvailableTrends();
    }
     ...
     * @param callback the {@link org.mule.api.callback.SourceCallback} used to dispatch messages when a response is received
     */
    @OAuthProtected
    @Source
    //TODO as part of the OAuth support, we need a hook to a listener to make this work properly for OAuth cases.
    ...
    public void userStream(@Placement(group = "Keywords to Track") List<String> keywords, final SourceCallback callback_) {
        ...
        getTwitterStream().addListener(new UserStreamAdapter() {
            ...
            public void onStatus(Status status) {
                try {
                    callback.process(UserEvent.fromPayload(UserEvent.EventType.NEW_STATUS, status.getUser(), status));
                } catch (Exception e) {
            ...
            public void onBlock(User source, User blockedUser) {
                try {
                    callback.process(UserEvent.fromTarget(UserEvent.EventType.BLOCK, source, blockedUser));
                } catch (Exception e) {
                    logger.error(e.getMessage(), e);
                }
            }
            ...
            public void onFollow(User source, User followedUser) {
                try {
                    callback.process(UserEvent.fromTarget(UserEvent.EventType.FOLLOW, source, followedUser));
                } catch (Exception e) {
                    logger.error(e.getMessage(), e);
                }
            }
            ...
            public void onUnblock(User source, User unblockedUser) {
                try {
                    callback.process(UserEvent.fromTarget(UserEvent.EventType.UNBLOCK, source, unblockedUser));
                } catch (Exception e) {
                    logger.error(e.getMessage(), e);
                }
            }
            ...
            public void onUserListCreation(User listOwner, UserList list) {
                try {
                    callback.process(UserEvent.fromPayload(UserEvent.EventType.LIST_CREATION, listOwner, list));
                } catch (Exception e) {
                    logger.error(e.getMessage(), e);
                }
            }
            ...
            public void onUserListDeletion(User listOwner, UserList list) {
                try {
                    callback.process(UserEvent.fromPayload(UserEvent.EventType.LIST_DELETION, listOwner, list));
                } catch (Exception e) {
                    logger.error(e.getMessage(), e);
                }
            }
            ...
            public void onUserListMemberAddition(User addedMember, User listOwner, UserList list) {
                try {
                    callback.process(UserEvent.from(UserEvent.EventType.LIST_MEMBER_ADDITION, addedMember, listOwner, list));
                } catch (Exception e) {
                    logger.error(e.getMessage(), e);
                }
            }
            ...
            public void onUserListMemberDeletion(User deletedMember, User listOwner, UserList list) {
                try {
                    callback.process(UserEvent.from(UserEvent.EventType.LIST_MEMBER_DELETION, deletedMember, listOwner,
                            list));
                } catch (Exception e) {
                    logger.error(e.getMessage(), e);
                }
            ...
            public void onUserListSubscription(User subscriber, User listOwner, UserList list) {
                try {
                    callback.process(UserEvent.from(UserEvent.EventType.LIST_SUBSCRIPTION, subscriber, listOwner, list));
                } catch (Exception e) {
                    logger.error(e.getMessage(), e);
                }
            }
            ...
            public void onUserListUnsubscription(User subscriber, User listOwner, UserList list) {
                try {
                    callback.process(UserEvent.from(UserEvent.EventType.LIST_UNSUBSCRIPTION, subscriber, listOwner, list));
                } catch (Exception e) {
                    logger.error(e.getMessage(), e);
                }
            }
            ...
            public void onUserListUpdate(User listOwner, UserList list) {
                try {
                    callback.process(UserEvent.fromPayload(UserEvent.EventType.LIST_UPDATE, listOwner, list));
                } catch (Exception e) {
                    logger.error(e.getMessage(), e);
                }
            }
            ...
            public void onUserProfileUpdate(User updatedUser) {
                try {
                    callback.process(UserEvent.fromPayload(UserEvent.EventType.PROFILE_UPDATE, updatedUser, null));
                } catch (Exception e) {
                    logger.error(e.getMessage(), e);
                }
            }
        });
        getTwitterStream().user(toStringArray(keywords));
    }
    ...
    public void siteStream(@Placement(group = "User Ids to Follow") List<String> userIds,
        ...
        final SoftCallback callback = new SoftCallback(callback_);
        getTwitterStream().addListener(new SiteStreamsAdapter() {
        ...
        getTwitterStream().site(withFollowings, toLongArray(userIds));
    }
    ...
    public DirectMessage sendDirectMessageByScreenName(String screenName, String message) throws TwitterException {
        return getTwitter().sendDirectMessage(screenName, message);
    }
    ...
    public DirectMessage sendDirectMessageByUserId(long userId, String message) throws TwitterException {
        return getTwitter().sendDirectMessage(userId, message);
    }
    ...
    public Trends getPlaceTrends(@Optional @Default("1") int woeid) throws TwitterException{
        return getTwitter().getPlaceTrends(woeid);
    }
    ...
    public ResponseList<Location> getClosestTrends(double latitude, double longitude) throws TwitterException{
        return getTwitter().getClosestTrends(new GeoLocation(latitude, longitude));
    }
    ...
    private TwitterStream listenToStatues(final SourceCallback callback_) {
        final SoftCallback callback = new SoftCallback(callback_);
        getTwitterStream().addListener(new StatusAdapter() {
            @Override
            public void onException(Exception ex) {
